			...
			<div class='form-group row'>			
				...
				<div class='col-sm-4'>
					<div class="input-group">
						...
						<?php
							echo form_input(array('type'=>'text','id'=>'id','name'=>'id','class'=>'form-control input-sm','value'=>$id,'placeholder'=>'Id'));
							echo form_input(array('type'=>'text','id'=>'id_master','name'=>'id_master','class'=>'form-control input-sm','value'=>$idmaster,'placeholder'=>'Id Master'));
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl=base_url + active_controller +'/edit_detail';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
