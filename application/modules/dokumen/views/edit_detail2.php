<?php
	...
	foreach($row as $datas){
		...
		$iddetail  = $datas->id_detail;
		$iddetail1  = $datas->id_detail1;
	}
?>   
				...
				<div class='col-sm-4'>
					<div class="input-group">
						...
						<?php
							...
							echo form_input(array('type'=>'hidden','id'=>'id_detail1','name'=>'id_detail1','class'=>'form-control input-sm','value'=>$iddetail1,'placeholder'=>'Id Detail I'));
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl=base_url + active_controller +'/edit_detail2';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
