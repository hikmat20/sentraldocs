            ...
            <div class="card card-stretch shadow card-custom">
                <div class="card-header">
                    <h4 class="card-title text-muted"><i class="fa fa-file"></i>
                        ...
                        &nbsp <i class="fa fa-angle-right"></i> &nbsp <a href="<?= base_url('dokumen/subfolder/'); ?><?= $nama_master . "/" . $nama_subfolder . "/" . $nama_endfolder; ?>"><?= str_replace("-", " ", ucfirst($nama_endfolder)); ?></a>
                    </h4>
                </div>
                <div class="card-body">
