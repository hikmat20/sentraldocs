			  ...
			  $idjabatan = $jabatan;
					 ...
					 foreach($row1 as $datas1){
						...
						echo"<tr>";	
							...
							if($ENABLE_VIEW){	
							if($datas1->status_approve=='0' ){	?>
                            <a href="#" class="btn btn-sm btn-warning edit"title="Edit Data" data-id="<?php echo $datas1->id ?>" data-file="<?php echo $datas1->nama_file ?>" data-table="gambar"> <i class="fa fa-edit"></i><a/>							
							...
							// if(!empty($appr1)) {
							    ...
							    // echo "<td></td>";	
				             	// }						
										...
										if($datas2->status_approve=='0'){?>
										<a href="#" class="btn btn-sm btn-warning edit"title="Edit Data" data-id="<?php echo $datas2->id ?>" data-file="<?php echo $datas2->nama_file ?>" data-table="gambar1"><i class="fa fa-edit"></i><a/>							
							...
							// if(!empty($appr1)) {
							    ...
							    // echo "<td></td>";	
				             	// }	
												...
												<a href="#" class="btn btn-sm btn-warning edit"title="Edit Data" data-file="<?php echo $datas3->nama_file ?>" data-id="<?php echo $datas3->id ?>" data-table="gambar2">><i class="fa fa-check"></i><a/>							
