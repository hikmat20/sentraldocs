<form id="form">
  <div class="mb-3 row flex-nowrap">
    <label for="" class="col-3 col-form-label font-weight-bold"><?= $labe_name; ?></label>
    <div class="col-9">
  ...
  <div class="mb-3 row flex-nowrap">
    ...
    <div class="col-9">
      <input type="text" name="year" class="form-control form-control-solid w-25" readonly id="year" placeholder="Year" />
