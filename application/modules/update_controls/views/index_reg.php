			...
			<div class="card card-stretch shadow card-custom">
				<div class="card-header">
					...
					<div class="mt-4 float-right ">
						<button type="button" class="btn btn-primary" id="add" title="Add New Update">
				...
				<div class="card-body">
					<div class="tab-content mt-3">
						<div class="tab-pane fade active show" role="tabpanel" aria-labelledby="Published-tab">
...
<script>
	$(document).ready(function() {
		...
		$(document).on('change', '#data_id', function() {
			...
			if (id) {
				$.ajax({
					url: siteurl + active_controller + 'load_regulations',
					type: 'POST',
					dataType: 'JSON',
					data: {
						id
		...
		$(document).on('click', '#add', function() {
			const url = siteurl + active_controller + 'add_update_reg';
		...
		$(document).on('click', '.edit', function() {
			...
			const url = siteurl + active_controller + 'edit_reg/' + id;
