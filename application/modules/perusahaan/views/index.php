...
<div class="box">
	...
	<div class="box-body">
		...
		<tr>
		    <td><?= $numb; ?></td>
			<td><?= $record->nm_perusahaan ?></td>			
			<td style="padding-left:20px">
			<?php if($ENABLE_MANAGE) : ?>
				<a class="text-green" id="edit" href="javascript:void(0)" title="Edit" data-perusahaan="<?=$record->id_perusahaan?>"><i class="fa fa-pencil"></i>
				</a>
			<?php endif; ?>

			<?php if($ENABLE_DELETE) : ?>
				<a class="text-red" href="javascript:void(0)" title="Delete" onclick="delete_data('<?=$record->id_perusahaan?>')"><i class="fa fa-trash"></i>
				</a>
			<?php endif; ?>
			</td>
		</tr>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><span class="fa fa-file-pdf-o"></span>&nbsp;Add Perusahaan</h4>
      </div>
