										...
										foreach ($data as $dt) : $n++; ?>
											<tr class="">
												...
												<td class="text-center">
													<a href="<?= base_url($this->uri->segment(1) . "/detail/" . $dt->id); ?>" class="btn btn-sm btn-icon rounded-circle btn-warning detail" data-id="<?= $dt->id; ?>" title="Edit Data"><i class="fa fa-arrow-circle-right"></i></a>
												</td>
											</tr>
									<?php endforeach;
									endif; ?>
