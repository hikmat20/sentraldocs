<div class="content d-flex flex-column flex-column-fluid p-0">
	<div class="container mt-10">
		<div class="mb-10">
			<h1 style="font-size: 36px;" class="text-white font-weight-bolder"><U>CORRECTION DOCUMENTS</U></h1>
							...
							foreach ($files as $list) : $n++; ?>
								<tr class="<?= ($list->flag_type == 'FOLDER') ? 'folder' : 'file'; ?>" data-id="<?= $list->id; ?>">
									...
									<td class="text-center">
										<button type="button" data-id="<?= $list->id; ?>" class="btn btn-pirmary btn-icon update-correction btn-warning btn-xs shadow-sm"><i class="fa fa-cog"></i></button>
									</td>
								</tr>
							<?php endforeach;
						else : ?>
