                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="javascript:void(0)" tooltip="qtip" onclick="_download('<?= $doc->id; ?>')" class="btn btn-icon btn-info btn-xs btn-shadow ml-2" title="Download Dokumen"><i class="fa fa-download"></i></a>
                                                <a href="javascript:void(0)" tooltip="qtip" onclick="delete_file(<?= $doc->id; ?>)" class="btn btn-icon btn-danger btn-xs btn-shadow ml-2" title="Delete Dokumen"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
