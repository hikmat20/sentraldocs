				...
				<div class='col-sm-4'>
					<div class="input-group">
						...
						<?php
							...
							echo form_input(array('type'=>'hidden','id'=>'id_detail','name'=>'id_detail','class'=>'form-control input-sm','value'=>$iddetail,'placeholder'=>'Id Master'));
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl=base_url + active_controller +'/edit_detail1';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
