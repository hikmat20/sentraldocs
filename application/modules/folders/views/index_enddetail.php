                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="javascript:void(0)" tooltip="qtip" data-file="<?= $doc->nama_file ?>" data-id="<?= $doc->id ?>" data-table="gambar2" class="btn btn-icon btn-primary btn-xs btn-shadow ml-2 edit" title="Revisi Dokumen"><i class="fa fa-pen"></i></a>
                                            <a href="javascript:void(0)" onclick="_download(<?= $doc->id; ?>)" tooltip="qtip" data-file="<?= $doc->nama_file ?>" data-id="<?= $doc->id ?>" class="btn btn-icon btn-info btn-xs btn-shadow ml-2" title="Download"><i class="fa fa-download"></i></a>
