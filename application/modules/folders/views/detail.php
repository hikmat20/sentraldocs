...
<div class="box box-primary">
	<div class="box-header">
		...
		<?php
			if($ENABLE_ADD){
		?>
		  <a href="<?php echo site_url('folders/add_detail?id_master='.$mtr) ?>" class="btn btn-sm btn-success" id='btn-add'>
			<i class="fa fa-plus"></i> Add
		  </a>
		  <a href="<?php echo site_url('folders') ?>" class="btn btn-sm btn-success" id='btn-add'>
				  ...
				  $int	=0;
					foreach($row as $datas){ 
						...
						echo"<tr>";	
							...
							<?php
							// echo"<a href='".site_url('folders/add_subdetail1/'.$datas->id.'/'.$datas->id_master)."' class='btn btn-sm btn-primary' title='Tambah Sub Dokumen' data-role='qtip'><i class='fa fa-plus'></i></a>";
							// }
							
							if ($ENABLE_VIEW){	
							echo"<a href='".site_url('folders/detail1?id_detail='.$datas->id)."' class='btn btn-sm btn-primary' title='Buka Folder' data-role='qtip'><i class='fa fa-folder-open'></i></a>";
							}
							...
							<?php
							echo"<a href='".site_url('folders/download/'.$datas->nama_file)."' class='btn btn-sm btn-primary' title='Download Data' data-role='qtip'><i class='fa fa-download'></i></a>";
							?>
							
							<a href="#" class="btn btn-sm btn-warning edit"title="Revisi Data" data-file="<?php echo $datas->nama_file ?>" data-id="<?php echo $datas->id ?>" data-table="gambar"><i class="fa fa-edit"></i><a/>
							
							
							<?php
							}
							if($ENABLE_DELETE){ 
                          	echo"&nbsp;<a href='".site_url('folders/delete_detail/'.$datas->id)."' class='btn btn-sm btn-danger' title='Delete Data' data-role='qtip'><i class='fa fa-trash'></i></a>";
							}
							echo"</td>";
   						    echo"</tr>";
