...
<div class="tab-content mt-5">
    <div class="tab-pane fade show active" id="file" role="tabpanel" aria-labelledby="file-tab">
        ...
        <?php if ($file->ext == '.pdf' || $file->ext == '.PDF') : ?>
            <iframe src="<?= base_url("directory/MANUAL/$company/" . (isset($type) ? $type . '/' : '') . "$company/" . str_replace(":", "-", $dir_name) . "/$file->file_name"); ?>#toolbar=0&navpanes=0" frameborder="0" width="100%" height="400px"></iframe>
        <?php else : ?>
